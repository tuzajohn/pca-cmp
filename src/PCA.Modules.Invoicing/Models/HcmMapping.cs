...
public class HcmMapping
{
    ...
    public string  Classification { get; set; } = string.Empty; // BASIC_SALARY|ALLOWANCE|STATUTORY|LOAN_DEDUCTION|IGNORE
    ...
    public static class Classifications
    {
        ...
        public const string LoanDeduction  = "LOAN_DEDUCTION";
        public const string Ignore         = "IGNORE";

        public static readonly string[] All =
            { BasicSalary, Allowance, Statutory, LoanDeduction, Ignore };
    }
