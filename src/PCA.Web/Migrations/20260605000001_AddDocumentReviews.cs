...
namespace PCA.Web.Migrations
{
    ...
    public partial class AddDocumentReviews : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewedById = table.Column<string>(type: "varchar(255)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentReviews_AspNetUsers_ReviewedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentReviews_ReviewedById",
                table: "DocumentReviews",
                column: "ReviewedById");
        }
        ...
        {
            migrationBuilder.DropTable(name: "DocumentReviews");
        }
    }
}
